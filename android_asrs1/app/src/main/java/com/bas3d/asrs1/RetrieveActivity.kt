...
class RetrieveActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val yeah=findViewById<Button>(R.id.button13)
        yeah.setOnClickListener {
            ...
            val req = JsonObjectRequest(Request.Method.GET, url,null, Response.Listener
            {
                ...
                val intent4= Intent(this,ThankuRActivity :: class.java)
        ...
        val not=findViewById<Button>(R.id.button14)
        not.setOnClickListener {
            val queue = Volley.newRequestQueue(this)
            val url = "http://$myip/?cmd=PUSHCARD"
