...
class ThankuRActivity : AppCompatActivity() {
    val myip=Global().ip
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_thankur)
        Toast.makeText(this,"Your card retrieved successfully", Toast.LENGTH_SHORT).show()
